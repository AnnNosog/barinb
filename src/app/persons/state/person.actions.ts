...
import { Entity } from '../../core/common/entity.interface';
import { payload } from '../../core/store/utils/payload.util';
import { ChangedPerson, ChangedPersonBuilding, ChangePersonBuilding, NewPerson, PersonEntity } from '../common/person.interface';
