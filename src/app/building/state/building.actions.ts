...
import { Building, BuildingEntity, ChangeBuildingRoom, ChangedBuilding, ChangedBuildingRoom, NewBuilding } from '../common/building.interface';
import { Entity } from '../../../app/core/common/entity.interface';
import { payload } from '../../../app/core/store/utils/payload.util';
